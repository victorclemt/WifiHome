// promotions_template_3.js

FormWidget.registerTypeStandard("promotions_template_3");

function promotions_template_3(_json, _options){
   	this.super(_json, _options);
   	this._userData = _options.userData;
}

promotions_template_3.inherits(FormWidget);

promotions_template_3.prototype.onEnter = function onEnter(_data){
...
promotions_template_3.prototype.onExit = function onExit(_data){
...
promotions_template_3.prototype.getPromotion = function getPromotion(id_promo){
...
promotions_template_3.prototype.responseGetPromotion = function responseGetPromotion(response){
...
promotions_template_3.prototype.onStreamEvent = function onStreamEvent(event) {
	var widgets = this.widgets;
	switch(event.type){
		case "end":
		case "endOfFile":
			if(this.statusPlayer == "mini"){
				...
				this.home.widgets.player.stateChange("player_promos_3");				
...
promotions_template_3.prototype.showHome = function showHome(_promo){
	var widgets = this.widgets;
...
promotions_template_3.prototype.getSucs = function getSucs(id_promo){
	var params = ["prmId="+id_promo];
	getServices.getSingleton().call("ADMIN_GET_SUCS_PROMOS",params, this.responseGetSucs.bind(this));

}

promotions_template_3.prototype.responseGetSucs = function responseGetSucs(response){
	if(response.status == 200){
...
promotions_template_3.prototype.showListItems = function showListItems(_sucs){
...
promotions_template_3.prototype.callItem = function callItem(_data){
...
promotions_template_3.prototype.sendCall = function sendCall(_phone){
	var params = ["mdnDest="+_phone];
	getServices.getSingleton().call("ADMIN_SEND_CALL",params, this.responseGetCall.bind(this));

}

promotions_template_3.prototype.responseGetCall = function responseGetCall(response){
	if(response.status == 200){
		this.actualFocus = "sucs";		
...
promotions_template_3.prototype.getGallery = function getGallery(id_promo){
	var params = ["prmId="+id_promo];
	getServices.getSingleton().call("ADMIN_GET_GALLERY_PROMOS",params, this.responseGetGallery.bind(this));

}

promotions_template_3.prototype.responseGetGallery = function responseGetGallery(response){
	if(response.status == 200){
...
promotions_template_3.prototype.showGallery = function showGallery(_gallery){
...
promotions_template_3.onFocusSucs = function onFocusSucs(_focus,_data){
	var widgets = this.widgets;
	if(_focus){
...
promotions_template_3.onKeyPress = function onKeyPress(_key){
...
promotions_template_3.prototype.onKeyPressApp = function onKeyPressApp(_key){
	var widgets = this.widgets,
...
promotions_template_3.prototype.onKeyPressList001 = function onKeyPressList001(_key){
	var widgets = this.widgets,
		list01 = widgets.list01,
		list02 = widgets.list02,
		list03 = widgets.list03;		
...
promotions_template_3.prototype.onKeyPressList002 = function onKeyPressList002(_key){
	var widgets = this.widgets,
		list01 = widgets.list01,
		list02 = widgets.list02,
		list03 = widgets.list03,
...
promotions_template_3.prototype.onKeyPressList003 = function onKeyPressList003(_key){
	var widgets = this.widgets,
		list01 = widgets.list01,
		list02 = widgets.list02,
		list03 = widgets.list03,
...
promotions_template_3.prototype.onKeyPressListSucs = function onKeyPressListSucs(_key){
	var widgets = this.widgets,
...
promotions_template_3.prototype.onKeyPressListGallery = function onKeyPressListGallery(_key){
...
promotions_template_3.prototype.onKeyPressVideo = function onKeyPressVideo(_key){
	var widgets = this.widgets,
		list01 = widgets.list01,
		list02 = widgets.list02,
		list03 = widgets.list03,
...
promotions_template_3.prototype.onKeyPressSearch = function onKeyPressSearch(_key){	
	var widgets = this.widgets;
...
promotions_template_3.onFocusList01 = function onFocusList01(_focus,_data){
	var widgets = this.widgets;
   	if(_focus){                        
    	if(this.actualFocus == "app" || this.actualFocus == "section_2" || this.actualFocus == "section_3" || this.actualFocus == "search"){
        	widgets.list01.setFocus(false);       
        }        
   }
...
promotions_template_3.onFocusList02 = function onFocusList02(_focus,_data){
	var widgets = this.widgets;
   	if(_focus){                             
...
promotions_template_3.onFocusList03 = function onFocusList03(_focus,_data){
	var widgets = this.widgets;
   	if(_focus){                             
    	if(this.actualFocus == "app" || this.actualFocus == "section_1" || this.actualFocus == "section_2"){
...
promotions_template_3.drawMainApp = function drawMainApp(_data){ 	
...
promotions_template_3.drawList01 = function drawList01(_data){ 	
...
promotions_template_3.drawList02 = function drawList02(_data){ 	
...
promotions_template_3.drawList03 = function drawList03(_data){ 	
...
promotions_template_3.drawGeneralPanelList = function drawGeneralPanelList(_data){ 	
	var ctx = this.getContext("2d");
	ctx.beginObject();
    ctx.clear();
...
promotions_template_3.drawGeneralPanelLCall = function drawGeneralPanelLCall(_data){ 	
	var ctx = this.getContext("2d");
	ctx.beginObject();
    ctx.clear();
...
promotions_template_3.drawListSucs = function drawListSucs(_data){
	this.draw = function draw(focus) {
		var ctx = this.getContext("2d");
		ctx.beginObject();
   	 	ctx.clear();
...
promotions_template_3.drawListGallery = function drawListGallery(_data){
...
promotions_template_3.drawArrow = function drawArrow(_data){
	var ctx = this.getContext("2d");
	ctx.beginObject();
    ctx.clear();     
...
promotions_template_3.drawExitsections = function drawExitsections(_data){
	var ctx = this.getContext("2d");
	ctx.beginObject();
    ctx.clear();     
...
promotions_template_3.drawStroke = function drawStroke(data){
	var ctx = this.getContext("2d");
	ctx.beginObject();
	ctx.clear();
...
promotions_template_3.drawBackX = function drawBackX(_data){ 	
	var ctx = this.getContext("2d");
	ctx.beginObject();
    ctx.clear();
...
promotions_template_3.drawTerms = function drawTerms(_data){ 	
	var ctx = this.getContext("2d");
	ctx.beginObject();
    ctx.clear();
...
promotions_template_3.drawBackGallery = function drawBackGallery(_data){ 	
	var ctx = this.getContext("2d");
	ctx.beginObject();
    ctx.clear();
